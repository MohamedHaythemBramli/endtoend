package com.fullstack.backend.resource;


import com.fullstack.backend.dto.UserDTO;
import com.fullstack.backend.event.NewUserEvent;
import com.fullstack.backend.exception.ApiException;
import com.fullstack.backend.form.*;
import com.fullstack.backend.models.HttpResponse;
import com.fullstack.backend.models.User;
import com.fullstack.backend.models.UserPrincipal;
import com.fullstack.backend.provider.TokenProvider;
...
import static com.fullstack.backend.dtomapper.UserDTOMapper.toUser;
import static com.fullstack.backend.enumeration.EventType.*;
import static com.fullstack.backend.utils.ExceptionUtils.processError;
import static com.fullstack.backend.utils.UserUtils.getAuthenticatedUser;
import static com.fullstack.backend.utils.UserUtils.getLoggedInUser;
